...
export const SOUNDSCAPE_LIBRARY = [
  {
    ...
    emoji: "🌧️",
    title: "Soft Rain",
    subtitle: "Steady rain for emotional decompression",
  ...
  },
  {
    ...
    emoji: "🌲",
    title: "Forest Breeze",
    subtitle: "Leaves and wind to settle racing thoughts",
    category: "Nature Calm",
    accent: "#D1FAE5",
  },
  {
    ...
    emoji: "🌊",
    title: "Ocean Waves",
    subtitle: "Slow tide rhythm for breath syncing",
    category: "Nature Calm",
    accent: "#E0F2FE",
  },
  {
    ...
    emoji: "🏞️",
    title: "River Flow",
    subtitle: "Continuous stream noise to improve focus",
    category: "Nature Calm",
    accent: "#DBEAFE",
  },
  {
    ...
    subtitle: "Crickets and soft night air for winding down",
    category: "Sleep Prep",
    accent: "#EDE9FE",
  },
  {
    ...
    emoji: "🔥",
    title: "Fireplace",
    subtitle: "Warm crackles for grounded comfort",
    category: "Cozy Grounding",
    accent: "#FEF3C7",
  },
  {
    id: "white",
    emoji: "⚪",
    title: "White Noise",
    subtitle: "Even masking noise to reduce overwhelm",
  ...
  },
  {
    ...
    emoji: "🌸",
    title: "Pink Noise",
    subtitle: "Softer tone for calming nervous tension",
    category: "Focus Noise",
    accent: "#FCE7F3",
  },
  {
    ...
    emoji: "🟤",
    title: "Brown Noise",
    subtitle: "Deep steady hum for high-stress moments",
    category: "Deep Relax",
    accent: "#F3E8D8",
  },
  {
    ...
    emoji: "🎹",
    title: "Soft Piano",
    subtitle: "Slow instrumental phrases for emotional reset",
    category: "Gentle Music",
    accent: "#DBEAFE",
  },
];
