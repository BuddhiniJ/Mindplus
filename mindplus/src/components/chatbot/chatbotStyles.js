...
const styles = StyleSheet.create({
  ...
  promptEditorCheckboxText: {
    fontSize: 14,
    fontWeight: "700",
    color: "#6366F1",
  },
  promptEditorOrderButtons: {
    flexDirection: "column",
    alignItems: "center",
    justifyContent: "center",
    gap: 0,
  },
  promptEditorOrderButton: {
    width: 20,
    height: 20,
    justifyContent: "center",
    alignItems: "center",
  ...
  promptEditorOrderButtonText: {
    fontSize: 16,
    fontWeight: "700",
    color: "#6366F1",
  },
  promptEditorOrderIndex: {
    fontSize: 18,
    fontWeight: "800",
    color: "#3B82F6",
    textAlign: "center",
