...
export default function Dass21Screen2({ route, navigation }) {
  ...
  const handleNext = () => {
    ...
    navigation.navigate("Dass21Screen3", {
      answersPart1,
      answersPart2: answers
    });
  };
  ...
  const calculateOverallProgress = () => {
    const totalAnswered = Object.keys(answersPart1).length + Object.keys(answers).length;
      ...
      >
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            style={[
              styles.nextButton,
              Object.keys(answers).length === questions.length && styles.nextButtonActive
            ]}
            onPress={handleNext}
            activeOpacity={0.8}
          >
